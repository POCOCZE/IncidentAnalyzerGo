...
const EnableMenu = ({selected, onSelect}: MenuProps) => {
    ...
    const menuIconParams = 'fill-base-content/80'
    ...
    return(
        <ul className="menu rounded-box">
            <li className={selected === 'Home' ? menuParams : ''} onClick={() => selectedLogic('Home')}>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`size-6 ${selected === 'Home' && menuIconParams}`}>
            ...
            <li className={selected === 'Add' ? menuParams : ''} onClick={() => {selectedLogic('Add')}}>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`size-6 ${selected === 'Add' && menuIconParams}`}>
            ...
            <li className={selected === 'Incidents' ? menuParams : ''} onClick={() => {selectedLogic('Incidents')}}>
                <div className="indicator">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`size-6 ${selected === 'Incidents' && menuIconParams}`}>
            ...
            <li className={selected === 'Report' ? menuParams : ''} onClick={() => {selectedLogic('Report')}}>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`size-6 ${selected === 'Report' && menuIconParams}`}>
